...
<body>
    <ul>
        <li><a href="#section1">Update</a></li>
        ...
        <section id="section1">
            <div class="container">
                <form action="update" method="post">
                    ...
                    <div>
                        UserName
                        <input type="text" name="username" value="${login.username}" onkeyup="validateUserName()"  id="username" class="form-control" >
                        <small id="usernameError"></small>
                    </div>

                    <div>
                        password
                        <input type="password" name="password" value="${login.password}" onkeyup="validatePassword()"  id="password" class="form-control" maxlength=20 >
                        <small id="passwordError"></small>
                    </div>
                    <div>
                        Mobile
                        <input type="number" name="mobile" value="${login.mobile}" onkeyup="validateMobile()"  id="mobile" class="form-control"  maxlength=10 />
                        <small id="mobileError"></small>
                    </div>
                    <div>
                        Email
                        <input type="email" name="email" value="${login.email}" class="form-control" >
                    </div>
                    <div>
                        City
                        <input type="text" name="city" value="${login.city}" class="form-control">
                    </div>
